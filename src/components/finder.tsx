...
const finder = () => {
    ...
    return (
        <div className={classes.finder}>
            ...
            <p>Finder é um projeto que eu fiz para treinar minhas habilidades com React, TypeScript, CSS Modules e Vite.
                Ele é um site que busca usuários do GitHub e mostra algumas informações sobre eles.</p>
        </div>
    )
}
